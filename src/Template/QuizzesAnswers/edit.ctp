...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $quizzesAnswer->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $quizzesAnswer->id)]
            )
        ?></li>
...
<div class="quizzesAnswers form large-9 medium-8 columns content">
    <?= $this->Form->create($quizzesAnswer) ?>
    <fieldset>
        <legend><?= __('Edit Quizzes Answer') ?></legend>
        <?php
